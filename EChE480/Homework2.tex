...
{\color{incolor}In [{\color{incolor}58}]:} \PY{n}{V} \PY{o}{=} \PY{l+m+mi}{10}\PY{o}{*}\PY{n}{c}\PY{o}{.}\PY{n}{milli}\PY{o}{*}\PY{n}{c}\PY{o}{.}\PY{n}{liter}
         ...
         \PY{k}{print}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{The charge on the sphere is \PYZob{}:.3g\PYZcb{} Volts, or \PYZob{}:,.5g\PYZcb{} teravolts}\PY{l+s}{\PYZdq{}}\PYZbs{}
               \PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{Voltage}\PY{p}{,}\PY{n}{Voltage}\PY{o}{/}\PY{n}{c}\PY{o}{.}\PY{n}{tera}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}181}]:} \PY{n}{e0} \PY{o}{=} \PY{l+m+mf}{1.602e\PYZhy{}19} \PY{c}{\PYZsh{}Coulombs/electron}
          ...
          \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{mobility}\PY{p}{)}\PY{p}{)}\PY{p}{:}
              ...
              \PY{k}{print}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{The relative mobility of \PYZob{}:\PYZcb{} is \PYZob{}:\PYZgt{}6.2e\PYZcb{} cm\PYZca{}2/(V sec)}\PY{l+s}{\PYZdq{}}\PYZbs{}
                    \PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{lab}\PY{p}{,}\PY{n+nb}{float}\PY{p}{(}\PY{n}{mobil}\PY{o}{/}\PY{n}{c}\PY{o}{.}\PY{n}{centi}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}\PY{p}{)}
          \PY{k}{print}\PY{p}{(}\PY{p}{)}
          \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{mobility}\PY{p}{)}\PY{p}{)}\PY{p}{:}
              \PY{n}{lab} \PY{o}{=} \PY{n}{rLabel}\PY{p}{[}\PY{n}{i}\PY{p}{]}
              \PY{n}{absmob}\PY{o}{=}\PY{n}{absmobil}\PY{p}{[}\PY{n}{i}\PY{p}{]}
              \PY{k}{print}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{The absolute mobility of \PYZob{}:\PYZcb{} is \PYZob{}:.3g\PYZcb{} (cm\PYZca{}2 mole)/(J sec)}\PY{l+s}{\PYZdq{}}\PYZbs{}
                    \PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{lab}\PY{p}{,}\PY{n+nb}{float}\PY{p}{(}\PY{n}{absmob}\PY{o}{/}\PY{n}{c}\PY{o}{.}\PY{n}{centi}\PY{o}{*}\PY{o}{*}\PY{l+m+mi}{2}\PY{p}{)}\PY{p}{)}\PY{p}{)}
          ...
          \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{absmobil}\PY{p}{)}\PY{p}{)}\PY{p}{:}
              \PY{k}{print}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{The lambda of \PYZob{}:\PYZcb{} is \PYZob{}:.2g\PYZcb{}, which is \PYZob{}:.2}\PY{l+s}{\PYZpc{}}\PY{l+s}{\PYZcb{} off from my estimate, which was \PYZob{}:.2g\PYZcb{}}\PY{l+s}{\PYZdq{}}\PYZbs{}
                    \PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{rLabel}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{,}\PYZbs{}
          ...
          \PY{k}{print}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{The differences come from the solvated radii, as opposed to the }\PY{l+s+se}{\PYZbs{}}
          \PY{l+s}{        crystallographic radii. H3O+ will be attracted to the }\PY{l+s+se}{\PYZbs{}}
          ...
          \PY{k}{print}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{\PYZdq{}}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{(d)}\PY{l+s}{\PYZdq{}}\PY{p}{,}\PY{l+s}{\PYZdq{}}\PY{l+s}{The approximated conductivity is \PYZob{}:.2f\PYZcb{} S/cm}\PY{l+s}{\PYZdq{}}\PYZbs{}
                \PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{kappaEst}\PY{o}{*}\PY{n}{c}\PY{o}{.}\PY{n}{liter}\PY{p}{)}\PY{p}{,}\PY{n}{sep}\PY{o}{=}\PY{l+s}{\PYZdq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}287}]:} \PY{n}{dVdx} \PY{o}{=} \PY{l+m+mi}{1}\PY{o}{/}\PY{n}{c}\PY{o}{.}\PY{n}{centi}
          ...
          \PY{k}{print}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{The time to reach 63.2}\PY{l+s+si}{\PYZpc{} o}\PY{l+s}{f steady state velocity is \PYZob{}:.1f\PYZcb{} femtoseconds}\PY{l+s}{\PYZdq{}}\PYZbs{}
                \PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n+nb}{float}\PY{p}{(}\PY{n}{tSS}\PY{p}{)}\PY{o}{/}\PY{n}{c}\PY{o}{.}\PY{n}{femto}\PY{p}{)}\PY{p}{)}
          ...
          \PY{k}{print}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{The ion will travel \PYZob{}:.1g\PYZcb{} meters (\PYZob{}:.2f\PYZcb{} zm) before reaching 90}\PY{l+s+si}{\PYZpc{} o}\PY{l+s}{f }\PY{l+s+se}{\PYZbs{}}
          \PY{l+s}{      its terminal velocity}\PY{l+s}{\PYZdq{}}\PYZbs{}
                \PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{x90}\PY{p}{,}\PY{n}{x90}\PY{o}{/}\PY{n}{c}\PY{o}{.}\PY{n}{zepto}\PY{p}{)}\PY{p}{)}
...
The steady state velocity is 4.7e-06 m/s
    ...
    \begin{center}
    \adjustimage{max size={0.9\linewidth}{0.9\paperheight}}{Homework2_files/Homework2_11_1.png}
    \end{center}
    { \hspace*{\fill} \\}
